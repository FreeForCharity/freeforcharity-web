              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left">
                ...
                <div className="sm:pl-[15px]">
                  ...
                  <p
                    ...
                    id="fauna-font"
                  >
                    The Endowment ensures that only the investment gains are
                    used, providing a sustainable funding source for the Free
                    For Charity Domain Program.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left">
                ...
                <div className="sm:pl-[15px]">
                  ...
                  <p
                    ...
                    id="fauna-font"
                  >
                    Our target is to raise $1,000,000 to secure the future of
                    the program, ensuring ongoing support for countless
                    charities.
                  </p>
                </div>
              </div>
