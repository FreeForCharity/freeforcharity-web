        ...
        <div className="w-full md:w-[47%] md:mr-[5.5%] flex flex-col justify-between bg-transparent">
          <div>
            ...
            >
              ...
              Charity it is our mission to provide world class services to other
            ...
            >
              ...
              for software to support our training programs; Free for Charity
              can always put to good use your donation. Consider your options to
              donate today.
            </p>
            <p
            ...
            >
              ...
              business). Take a look at the volunteer opportunities today.
            </p>
          </div>
        </div>
        ...
        <div className="w-full md:w-[50%] flex items-stretch">
          <div className="bg-[#7EBEC5] flex flex-col justify-center items-center text-center py-[20px] md:py-[40px] md:px-[60px] px-[30px] w-full h-full">
            ...
            <p
              ...
              id="aria-font"
            >
              Click the button below to make a donation at PayPal and support
              Free For Charity. Your contribution will make a meaningful impact
              in helping us provide world-class training programs and support
              charities throughout the United States. From covering the costs of
              running servers and websites to supporting our training programs,
              every donation counts. Help us continue our mission by donating
              today.
            </p>
