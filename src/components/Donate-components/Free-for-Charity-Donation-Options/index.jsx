      ...
      <div className="w-full max-w-[90%] md:max-w-[80%] py-4 mx-auto">
        ...
        <div className="text-center">
          ...
          <p
            ...
            id="lato-font"
          >
            Here at free for charity we make it easy to donate and help the
            cause of great free training programs and free services for
            charities.
          </p>
          <p
        ...
        <div className="bg-[#7EBEC5] py-[20px] md:py-[40px] md:px-[60px]  px-[30px] flex flex-col items-center justify-center text-center">
          ...
          <Transparentbtn text="Make a Lasting Impact Today!" />
        </div>
      </div>
    </div>
  );
