      ...
      <div className="w-[90%] md:w-[80%] max-w-[1080px] mx-auto relative z-[2]">
        <div className="relative py-[27px] flex flex-col md:flex-row items-start">
          ...
          <div className="w-full md:w-[48.5%] text-[15px] leading-[1.6]">
            ...
            >
              <li>
                NOTE: Save the account name and password that you set up as well
                as the subdomain e.g. yourcharity.onmicrosoft.com
                <br />
              ...
              <li>
                ...
                <br />
                1. Follow all steps in the Microsoft Guide “Add a Domain to
                Microsoft 365”
                <br />
                2. (
                <a
                ...
                <br />
                3. You will need your Cloudflare Username and Password from
                before but if you are still logged in this will help
                <br />
                4. If you get stuck, you can put in a ticket with Microsoft and
                text Clarke Moyer at 520-222-8104
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="py-[27px]">
          <p
            ...
            id="aria-font"
          >
            DOMAIN NAME COUPON CODE Thank you for choosing us to help with your
            domain name and email setup. To get the code please complete the
            onboarding form for either 501c3 or pre-501c3 and you will see the
            code in the email confirmation that comes after you finish. If you
            run into any questions, contact Clarke Moyer (520) 222-8104.
          </p>
        </div>
      </div>
      {/* Background Wave */}
