          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            ...
            <div>
              ...
              >
                ...
                received a grant specifically for domain names or hosting but
                uses individual and business contributions to fund this program.
              </AccordionItem>
              ...
              >
                Yes, We have had IRS designation since 2014 and have been
                building our systems and testing or support for several years.
                While charities for charities are rare they do exist and in fact
                fill an important need in reducing overhead expenses for other
                nonprofits. Our IRS designation number (EIN) is 46-2471893. You
                can see our guidestar profile{" "}
                <a
                  href="https://www.guidestar.org/profile/46-2471893"
                  className="text-[#0d7ff8]"
                >
                  here.
                </a>{" "}
                We are proud to also recommend other charities for charities
                that inspired us to{" "}
            ...
            <div>
              ...
              >
                ...
                <ul className="list-disc list-inside mt-1">
                  <li>
                    If you already have your 501(c)3 get your free domain from
                    us{" "}
                  ...
                  <li>
                    If you can provide your own qualified WordPress webmaster
                    you may be moved up in the list.
                  </li>
                </ul>
              </AccordionItem>
            </div>
