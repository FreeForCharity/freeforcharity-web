    ...
    <div className="w-full pt-[60px] pb-[40px] bg-[#FCFCFC]">
      ...
      <div className="w-full max-w-[90%] md:max-w-[80%] py-4 mx-auto">
        ...
        <div className="text-center">
          ...
          <p
            className="text-[18px] font-[500] text-black pb-[1em]"
            id="lato-font"
          >
            Free for Charity is always looking for motivated and skilled people
            from around the US to help guide and participate in our training
            programs and direct support to charities.
          </p>
          <p
            className="text-[18px] font-[700] text-black mb-[50px]"
            id="lato-font"
          >
        ...
        <div className="bg-[#7EBEC5] py-[20px] md:py-[40px] md:px-[60px]  px-[30px] flex flex-col items-center justify-center text-center">
          ...
          <p
            ...
            id="aria-font"
          >
            To ensure the highest standards of security and competence for the
            non-profits we serve, all prospective volunteers must first complete
            our{" "}
            <span className="font-[700]">
              Core Competencies Training Program.
            </span>{" "}
            This mandatory first step is our “proving ground” and ensures you
            have the foundational skills needed to succeed.
          </p>
          <p
            className="text-[14px] font-[500] leading-[24px] text-white pb-[20px]"
            id="aria-font"
          >
            After you have successfully completed the training and received your
      ...
      <div className="w-full max-w-[90%] mx-auto py-[3%] flex flex-col md:flex-row gap-8 md:gap-0">
        ...
        <div className="w-full md:w-[47%] md:mr-[5.5%]">
          <h1 className="text-[28px] font-[700] leading-[31px] text-[#f27022]">
            You can create a measurable impact to the success of charities
            nation wide with your donation or volunteer hours.
          </h1>
          <p
            className="text-[18px] font-[500] leading-[27px] mb-[5.82%] mt-[20px]"
            id="lato-font"
          >
            Every organizations success ultimately falls down to how much
            support the organization received for its causes. Here at Free for
            Charity it is our mission to provide world class training programs
            that at the same time help charities throughout the United States.
          </p>
          <h1 className="text-[28px] font-[700] leading-[31px] text-[#f27022]">
          ...
          <p
            ...
            id="lato-font"
          >
            From the day to day costs of running servers, websites, and paying
            for software to support our training programs; Free for Charity can
            always put to good use your donation. Consider your options to
            donate today.
          </p>
          <p
            className="text-[18px] font-[500] leading-[27px] mb-[5.82%]"
            id="lato-font"
          >
