    ...
    <div className="pt-[40px] md:pt-[60px] pb-[20px] md:pb-[28px] bg-[#fcfcfc]">
      <div className="w-[95%] md:w-[85%] mx-auto pt-0 md:pt-[30px] px-0 md:px-[31px] pb-0 md:pb-[19px]">
        ...
        >
          ...
          possible&nbsp;that current nonprofits pay for&nbsp;to for-profit
          companies with free or at-cost work from our campus,&nbsp;on-site
          projects,&nbsp;or partnerships with other entities.
        </p>
      </div>
    </div>
  );
