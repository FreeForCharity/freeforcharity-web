      ...
      <div className="w-[90%] mx-auto py-[40px] ">
        <div className="pt-[26px] w-full max-w-[90%] sm:max-w-[90%] mx-auto">
            ...
            <ul className="list-disc list-inside space-y-1 pb-[1em]">
              ...
              <li>
                <strong className="text-[#666]">
                  Find your nonprofit profile:
                </strong>{" "}
                Search for your organization using its name or Employer
                Identification Number (EIN).
              </li>
              <li>
                <strong className="text-[#666]"> Claim the profile:</strong>{" "}
          ...
          <AccordianBold number="2" title=" Earn a Bronze Seal of Transparency">
            <ul className="list-disc list-inside space-y-1 pb-[1em]">
              <li>
                ...
                Complete the fundamental information for your nonprofit,
                including:
          ...
          <AccordianBold number="3" title=" Earn a Silver Seal of Transparency">
            <ul className="list-disc list-inside space-y-1 pb-[1em]">
              <li>
                <strong className="text-[#666]">Program details:</strong> Add
                information about your nonprofit’s programs, including:
                <ul className="list-disc list-inside space-y-1 pl-[20px] pb-[20px]">
                  <li>Program names</li>
          ...
          <AccordianBold number="4" title=" Earn a Gold Seal of Transparency">
            <ul className="list-disc list-inside space-y-1 pb-[1em]">
              <li>
                <strong className="text-[#666]">Financial information:</strong>{" "}
                Upload detailed financial documents such as:
                <ul className="list-disc list-inside space-y-1 pl-[20px] pb-[20px]">
                  <li>Audited financial statements (if available)</li>
                  <li>IRS Form 990</li>
                  <li>
                    Fiscal year details, including revenue, expenses, assets,
                    and liabilities
                  </li>
                </ul>
              </li>
              <li>
                ...
                Include DEI data for your organization to further demonstrate
                your transparency.
              </li>
              <li>
                <strong className="text-[#666]"> Publication:</strong> After
          ...
          <AccordianBold
            number="5"
            title=" Earn a Platinum Seal of Transparency"
          >
            <ul className="list-disc list-inside space-y-1 pb-[1em]">
              <li>
                <strong className="text-[#666]">Impact metrics:</strong> Provide
                quantitative data that shows the impact of your nonprofit’s
                work. Some examples include:
                <ul className="list-disc list-inside space-y-1 pl-[20px] pb-[20px]">
                  <li>Number of individuals served</li>
                  <li>
                    Outcomes from specific programs (e.g., scholarships awarded,
                    animals rehabilitated, etc.)
                  </li>
                  <li>
                    Any relevant performance indicators specific to your mission
                  </li>
                </ul>
              </li>
              <li>
                <strong className="text-[#666]">Strategic goals: </strong>{" "}
        ...
        <div className="pt-[26px] max-w-[90%] sm:max-w-[90%] mx-auto">
          ...
          <p
            className="text-[14px] font-[500] text-[#666] mb-[30px]"
            id="aria-font"
          >
            Once you have published your report you will then be given a link to
            share your profile as well as some option for posting this badge to
            your website that we will need later.
          </p>
          <Image
        ...
        >
          <p className="font-[700] text-[#666] pb-[1em]">
            Here is an example of the links to copy into the FFC onboarding
            form:
          </p>
          <p className="font-[700] text-[#666] pb-[1em]">
            (These are examples only, please copy the links from your GuideStar
            profile.)
          </p>
          ...
          <p className="font-[500] text-[#666] pb-[1em] pt-[1em]">
            FFC GuideStar Seal Code (This isn’t needed for the onboarding form,
          ...
          />
          <p className="font-[500] text-[#666] pb-[1em]">
            Please keep your GuideStar profile handy while filling out the FFC
            onboarding form. A significant portion of the information we require
            can be copied over from what you provided to GuideStar while
            achieving your Seal of Transparency.
          </p>
        </div>
