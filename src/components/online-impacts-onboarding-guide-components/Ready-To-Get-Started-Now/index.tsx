    ...
    <div className="bg-white">
      <div className="w-full max-w-[90%] mx-auto">
        <div className="flex items-center flex-col text-center pb-[40px]">
          <h1
            className="text-[26px] font-[500] text-[#333] pb-[10px]"
            id="aria-font"
          >
        ...
        >
          <p
            className="text-[18px] font-[500] text-[#4a4a4a] mb-[1em]"
            id="lato-font"
          >
            Free For Charity Provides free .org domain names to US 501c3
            organizations. Once your onboarding forms are accepted you will
            receive an email from the system with the discount code to request a
            new domain name or to transfer your current domain name to us so we
            can start managing it and paying the annual fees.
          </p>
          ...
          <p className="text-[18px] font-[500] text-[#4a4a4a] mb-[1em]">
            Once we have the domain name under management we can then set up
            your professional email addresses e.g. board@yourcharityname.org
          </p>
        ...
        <AccordionItem
          number="4"
          title=" InterServer Nonprofit Hosting Request"
        >
          <div className="space-y-6 font-[500] text-[#666]">
            {/* Intro Paragraph */}
            <p className="pb-4 leading-relaxed">
              A very small number of hosting providers provide free hosting for
              nonprofits. We recommend InterServer, and use them for our own
              site to host the core WordPress files for your website. Below are
              instructions for how to get free hosting from InterServer and set
              it up so that we can help manage your site. Once we have access to
              your hosting and website we can then add in the extra WPMUDEV and
              DIVI capabilities to either create a totally new site or update
              your current site.
            </p>
              ...
              <ol className="list-decimal list-outside pl-5">
                ...
                <li>
                  ...
                  <ul className="list-disc list-inside ml-6 mt-2 ">
                    <li>
                      A copy of your IRS 501(c)(3) tax identification letter
                    </li>
                    <li>
                      The domain name you want hosted with InterServer (from the
                ...
                <li>
                  Wait for InterServer to set up your account (they will do this
                  promptly)
                </li>
                <li>
                  Once your account is set up, log in to your DirectAdmin panel
                </li>
              </ol>
            </div>
              ...
              <ol className="list-decimal list-outside  pl-5">
                ...
                <li>
                  ...
                  <ul className="list-disc list-inside mt-2 ">
                    ...
                    <li>
                      Leave the directory field blank for installation in the
                      root directory
                    </li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside pl-1 font-[700]">
                <li>
                  You <strong>must</strong> add the “Powered by InterServer”
                  link within <strong>30 days</strong>, or you’ll need to pay
                  for the hosting package
                </li>
                <li>
                  InterServer is a for-profit US company that provides free
                  hosting. Free For Charity is a 501(c)(3) technology adoption
                  charity; they are <em>separate entities</em>
                </li>
              </ul>
            </div>
