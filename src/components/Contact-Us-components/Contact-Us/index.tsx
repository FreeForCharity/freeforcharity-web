    ...
    <div className="py-[50px]">
      <div className="w-full max-w-[90%] mx-auto">
        ...
        <p
          ...
          id="lato-font"
        >
          Have questions about consultation or hosting? Want to know more about
          nonprofits? Looking to chat? Give a real person a call:
        </p>

        <div className="mt-[50px] grid grid-cols-1 md:grid-cols-3 gap-8 mb-6 py-6">
          {/* Email */}
