  ...
  return (
    <div className="bg-[#fcfcfc]">
      <div className="w-[90%] max-w-[90%] mx-auto py-[2%] items-center text-center">
        ...
        <p
          className="text-[18px] font-[500] color-black text-left"
          id="lato-font"
        >
          At Free For Charity, we believe that every non-profit deserves a
          powerful digital presence. That’s why we offer a comprehensive, modern
          tech stack to 501(c)(3) organizations – completely free of charge.
          When you partner with us, you’re not just getting a website; you’re
          embracing a full suite of top-tier digital tools.
        </p>
      </div>
      <div className="w-[90%] max-w-[90%] mx-auto py-[2%] items-center text-center">
        ...
        <p
          ...
          id="lato-font"
        >
          By choosing Free For Charity, you’re agreeing to adopt our carefully
          curated tech stack:
        </p>
      </div>
      ...
      <div className="w-full">
        <div className="w-[90%] max-w-[90%] mx-auto">
          ...
          <AccordionItem number="2" title=" Divi Theme">
            <ul className="list-disc list-inside space-y-1">
              <li>
                For You: Professional-looking website with drag-and-drop design
                capabilities
              </li>
              <li>
                For Us: Consistent, high-quality design across all charity
                partners
              </li>
            </ul>
          </AccordionItem>
          ...
          <AccordionItem number="7" title=" GuideStar">
            <ul className="list-disc list-inside space-y-1">
              <li>
                For You: Increased transparency and credibility with donors
              </li>
              <li>
                For Us: Verified financial and operational information about our
                partners
              </li>
            </ul>
          </AccordionItem>
