...
test.describe('Cookie Consent Banner', () => {
  ...
  test('should persist Accept All choice and not show banner on subsequent visits', async ({ page }) => {
    // Accept all cookies
    await page.getByRole('button', { name: 'Accept All' }).click();
  ...
  test('should persist Decline All choice and not show banner on subsequent visits', async ({ page }) => {
    // Decline all cookies
    await page.getByRole('button', { name: 'Decline All' }).click();
